...
function App() {
  ...
  return (
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10 text-2xl">
      ...
      <button onClick={resetHandler} className="bg-[#0398d4] text-white px-5 py2 rounded-sm text-lg">Reset</button>
    </div>
  );
}
